...
let meting_api =
	...
	"https://music.3e0.cn/?server=netease&type=playlist&id=8724039279";
// Meting API 的 ID，从配置中获取或使用默认值
let meting_id = musicPlayerConfig.id ?? "8724039279";
...
const localPlaylist = [
	...
	},
	{
		...
		url: "assets/music/url/OldTownLoad.mp3",
		duration: 180,
	},
	{
		id: 3,
		...
		url: "assets/music/url/CornfieldChase.mp3",
		duration: 200,
	},
];
