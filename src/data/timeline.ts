...
export const timelineData: TimelineItem[] = [
	// ========== 工作经历 ==========
	{
		...
		title: "AIC++教学导师",
		description:
			"在编程猫担任C++教学导师，负责学生教学、解答家长疑问、学生答疑等工作。",
		type: "work",
	...
	},
	{
		...
		title: "羽毛球教练（兼职）",
		description:
			"兼职羽毛球教练，从大学时期开始接触羽毛球教学，具备专业的技术指导和训练经验。",
		type: "work",
		startDate: "2022-09-01",
		location: "深圳",
		organization: "个人兼职",
		position: "羽毛球教练",
		skills: ["羽毛球", "教学", "体能训练", "沟通"],
		achievements: [
			"大学期间兼职羽毛球教练，积累教学经验",
			"带领学员参加校内羽毛球比赛",
			"帮助学员提升技术水平和比赛成绩",
	...
	// ========== 正在学习 ==========
	{
		...
		title: "持续学习中",
		description:
			"目前正在系统学习AI编程、出海运营、理财投资和SEO优化等领域知识，不断扩展技能边界。",
		type: "achievement",
		startDate: "2025-01-01",
		skills: ["AI编程", "出海运营", "理财投资", "SEO优化", "流量变现"],
		achievements: [
			"AI编程：使用Cursor、Copilot、ChatGPT等AI工具提升开发效率",
			"出海：研究AI工具站出海模式、流量获取与变现路径",
			"理财：关注A股、基金投资，学习资产配置知识",
			"SEO：学习网站SEO优化技巧，研究SimilarWeb、Ahrefs、Google趋势等工具",
		],
