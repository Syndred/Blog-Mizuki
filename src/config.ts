...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://syndred.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-01-28", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "ZCOOLKRegular",
			fontWeight: "500",
			localFonts: ["ZCOOLKRegular.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Syndred",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/488441708",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Syndred",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://music.3e0.cn/?server=netease&type=playlist&id=8724039279", // Meting API 地址
	id: "8724039279", // 歌单ID
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Syndred Website!", // 欢迎词
		touch: [
			"Hello~",
			"How's it going?",
			"Have a nice day!",
